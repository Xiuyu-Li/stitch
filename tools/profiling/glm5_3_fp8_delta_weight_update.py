"""Profile one checksummed GLM-5.3 fp8 update using the maintained recipe.
...
from cookbook.standalone.configs import glm5_3_fp8 as model
...
EXPERIMENT = "glm5_3_fp8"
BASE_CHECKPOINT = model.BASE_CHECKPOINT_PATH
...
app = modal.App("profile-glm5-3-fp8-delta-weight-update")
checkpoint_volume = modal.Volume.from_name(model.CHECKPOINT_VOLUME_NAME, version=2)
