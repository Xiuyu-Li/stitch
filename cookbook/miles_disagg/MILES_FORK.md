...
This test branch pins the candidate in [Miles #6](https://github.com/modal-projects/miles/pull/6)
for `modal-projects/miles:stitch-miles-fully-async-swe`. It contains a Miles
fully-async stack based on upstream main at `5330aadc0`, followed by the
